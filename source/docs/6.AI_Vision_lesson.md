...
<img class="common_img" src="../_static/media/chapter_6/section_1/image4.png" style="width:400px;"/>
...
[Color Recognition Program.sb3](../_static/source_code/ai_vision_lesson.zip)
...
<img class="common_img" src="../_static/media/chapter_6/section_3/image12.png" />
...
<img class="common_img" src="../_static/media/chapter_6/section_4/image3.png" style="350px;"/>

WonderCam is a user-friendly AI vision sensor with multiple built-in features, including color detection, face recognition, label recognition, line tracking, digit recognition, traffic sign recognition, image classification, and feature learning. It is compatible with various controllers such as ESP32, micro:bit, Arduino, and Raspberry Pi, making it easy to bring your AI vision projects to life.

### 6.4.3 Program Download 

[Color Tracking Program.sb3](../_static/source_code/ai_vision_lesson.zip)
...
<img class="common_img" src="../_static/media/chapter_6/section_4/image11.png" />
...
<img src="../_static/media/chapter_6/section_5/image9.jpeg" class="common_img"/>
...
<img class="common_img" src="../_static/media/chapter_6/section_6/image3.png" style="width:350px;"/>

WonderCam is a user-friendly AI vision sensor with multiple built-in features, including color detection, face recognition, label recognition, line tracking, digit recognition, traffic sign recognition, image classification, and feature learning. It is compatible with various controllers such as ESP32, micro:bit, Arduino, and Raspberry Pi, making it easy to bring your AI vision projects to life.

### 6.6.3 Program Download 

[Face Recognition Program.sb3](../_static/source_code/ai_vision_lesson.zip)
...
<img class="common_img" src="../_static/media/chapter_6/section_7/image3.png" style="width:350px;"/>

WonderCam is a user-friendly AI vision sensor with multiple built-in features, including color detection, face recognition, label recognition, line tracking, digit recognition, traffic sign recognition, image classification, and feature learning. It is compatible with various controllers such as ESP32, micro:bit, Arduino, and Raspberry Pi, making it easy to bring your AI vision projects to life.

### 6.7.3 Program Download 

[Face Tracking Program.sb3](../_static/source_code/ai_vision_lesson.zip)
...
<img class="common_img" src="../_static/media/chapter_6/section_7/image4.png" />
...
<img class="common_img" src="../_static/media/chapter_6/section_9/image3.png" style="width:350px;"/>

WonderCam is a user-friendly AI vision sensor with multiple built-in features, including color detection, face recognition, label recognition, line tracking, digit recognition, traffic sign recognition, image classification, and feature learning. It is compatible with various controllers such as ESP32, micro:bit, Arduino, and Raspberry Pi, making it easy to bring your AI vision projects to life.

### 6.9.3 Program Download 

[Tag Recognition Program.sb3](../_static/source_code/ai_vision_lesson.zip)
...
<img class="common_img" src="../_static/media/chapter_6/section_10/image3.png" style="width:350px;"/>

WonderCam is a user-friendly AI vision sensor with multiple built-in features, including color detection, face recognition, label recognition, line tracking, digit recognition, traffic sign recognition, image classification, and feature learning. It is compatible with various controllers such as ESP32, micro:bit, Arduino, and Raspberry Pi, making it easy to bring your AI vision projects to life.

### 6.10.3 Program Download 

[Tag Tracking Program.sb3](../_static/source_code/ai_vision_lesson.zip)
...
<img class="common_img" src="../_static/media/chapter_6/section_12/image2.png" />

### 6.12.2 WonderCam Vision Module

<img class="common_img" src="../_static/media/chapter_6/section_12/image3.png" style="width:350px;"/>

WonderCam is a user-friendly AI vision sensor with multiple built-in features, including color detection, face recognition, label recognition, line tracking, digit recognition, traffic sign recognition, image classification, and feature learning. It is compatible with various controllers such as ESP32, micro:bit, Arduino, and Raspberry Pi, making it easy to bring your AI vision projects to life.

### 6.12.3 Program Download 

[Traffic Sign Recognition Program.sb3](../_static/source_code/ai_vision_lesson.zip)
...
<img class="common_img" src="../_static/media/chapter_6/section_12/image5.png" />
...
| :--: | :----------------------------------------------------------: | :--------------: |
|  1   | <img src="../_static/media/chapter_6/section_12/image8.png" /> |   Go Straight    |
|  2   | <img src="../_static/media/chapter_6/section_12/image9.png" /> |    Turn Left     |
|  3   | <img src="../_static/media/chapter_6/section_12/image10.png" /> |    Turn Right    |
|  4   | <img src="../_static/media/chapter_6/section_12/image11.png" /> |      U-turn      |
|  5   | <img src="../_static/media/chapter_6/section_12/image12.png" /> |       Stop       |
...
<img class="common_img" src="../_static/media/chapter_6/section_12/image13.png" />

(2) When button A is pressed, the LEN_ON variable toggles between 1 and -1. This switch turns the fill light on or off based on the variable's current value.

<img class="common_img" src="../_static/media/chapter_6/section_12/image14.png" />
...
<img class="common_img" src="../_static/media/chapter_6/section_12/image15.png" />
...
<img class="common_img" src="../_static/media/chapter_6/section_12/image16.png" />
...
<img class="common_img" src="../_static/media/chapter_6/section_12/image17.png" />
...
<img class="common_img" src="../_static/media/chapter_6/section_12/image18.png" />

(7) If the traffic sign ID is 5, indicating stop, all motors are stopped.

<img class="common_img" src="../_static/media/chapter_6/section_12/image19.png" />
...
<img class="common_img" src="../_static/media/chapter_6/section_12/image20.png" />
...
<img class="common_img" src="../_static/media/chapter_6/section_14/image3.png" style="width:350px;"/>

WonderCam is a user-friendly AI vision sensor with multiple built-in features, including color detection, face recognition, label recognition, line tracking, digit recognition, traffic sign recognition, image classification, and feature learning. It is compatible with various controllers such as ESP32, micro:bit, Arduino, and Raspberry Pi, making it easy to bring your AI vision projects to life.

### 6.14.3 Program Download 

[Number Recognition Program.sb3](../_static/source_code/ai_vision_lesson.zip)
...
| :--: | :----------------------------------------------------------: | :----------------------------------------------------------: |
|  1   | <img src="../_static/media/chapter_6/section_14/image8.png" /> |                     RGB light turns red                      |
|  2   | <img src="../_static/media/chapter_6/section_14/image9.png" /> |                    RGB light turns purple                    |
|  3   | <img src="../_static/media/chapter_6/section_14/image10.png" /> |  RGB light turns green and plays the melody of "**Two Tigers**"  |
|  4   | <img src="../_static/media/chapter_6/section_14/image11.png" /> | RGB light turns blue and plays the melody of "**Twinkle Twinkle Little Star**" |
|  5   | <img src="../_static/media/chapter_6/section_14/image12.png" /> | RGB light turns yellow and plays the melody of "**Little Donkey**" |
...
<img class="common_img" src="../_static/media/chapter_6/section_14/image13.png" />

(2) When button A is pressed, the LEN_ON variable toggles between 1 and -1. This switch turns the fill light on or off based on the variable's current value.

<img class="common_img" src="../_static/media/chapter_6/section_14/image14.png" />
...
<img class="common_img" src="../_static/media/chapter_6/section_14/image15.png" />

(4) If the recognized digit is 2, set the LED color to purple.

<img class="common_img" src="../_static/media/chapter_6/section_14/image16.png" />

(5) If the recognized digit is 3, set the LED color to green and play the "**Two Tigers**" melody.

<img class="common_img" src="../_static/media/chapter_6/section_14/image17.png" />

The code snippet for the "**Two Tigers**" melody is as follows:

<img class="common_img" src="../_static/media/chapter_6/section_14/image18.png" />

(6) If the recognized digit is 4, set all LEDs to blue and play the "**Twinkle Twinkle Little Star**" melody.

<img class="common_img" src="../_static/media/chapter_6/section_14/image19.png" />

The code snippet for the "**Twinkle Twinkle Little Star**" melody is:

<img class="common_img" src="../_static/media/chapter_6/section_14/image20.png" />

(7) If the recognized digit is 5, set the LED color to light blue and play the "**Little Donkey**" melody.

<img class="common_img" src="../_static/media/chapter_6/section_14/image21.png" />

The code snippet for the "**Little Donkey**" melody is:

<img class="common_img" src="../_static/media/chapter_6/section_14/image22.png" />

(8) Otherwise, if other digits are recognized, set the LED color to yellow. If no digit is recognized, turn off all LEDs.

<img class="common_img" src="../_static/media/chapter_6/section_14/image23.png" />
...
<img class="common_img" src="../_static/media/chapter_6/section_16/image2.png" />

### 6.16.2 WonderCam Vision Module

<img class="common_img" src="../_static/media/chapter_6/section_16/image3.png" style="width:350px;"/>

WonderCam is a user-friendly AI vision sensor with multiple built-in features, including color detection, face recognition, label recognition, line tracking, digit recognition, traffic sign recognition, image classification, and feature learning. It is compatible with various controllers such as ESP32, micro:bit, Arduino, and Raspberry Pi, making it easy to bring your AI vision projects to life.

### 6.16.3 Program Download 

[Visual Line Following Program.sb3](../_static/source_code/ai_vision_lesson.zip))
...
<img class="common_img" src="../_static/media/chapter_6/section_16/image14.png" />

(8) Finally, if no line is detected, stop the robot and turn off all the LEDs.

<img class="common_img" src="../_static/media/chapter_6/section_16/image15.png" />



## **6.17 Image Classification Function Description**

### 6.17.1 Special Notes for Image Classification

The optimal distance between the card and the camera should be approximately 15-20 cm. Additionally, avoid overly dark background lighting. A plain-colored background, such as white, yields the best results.

### 6.17.2 Image Classification Function Introduction

Image classification uses a trained MobileNet model to categorize images based on the distinct features they contain. This approach enables applications such as icon recognition and garbage classification.

The WonderCam Vision Module comes with a factory-installed classification model for 12 cards. It can be used with the included garbage classification cards to perform these tasks.

### 6.17.3 Image Classification Operating Steps

#### 6.17.3.1 Entering the Mode

Slide the **Navigation Joystick** to the right until the menu bar displaying **Image Classification** appears at the top of the screen.

#### 6.17.3.2 Performing Image Classification

After the image classification function is enabled, classification tests can be performed on the 12 types of waste cards included with the product. Each card corresponds to a unique ID. During operation, the WonderCam Vision Module screen will display the ID with the highest confidence score and its corresponding confidence level. A confidence score closer to 1.0 indicates a more reliable recognition result.

<img src="../_static/media/chapter_6/section_17/image2.jpeg" class="common_img" style="width:600px;"/>

> [!NOTE]
>
> **The optimal distance between the card and the camera should be approximately 15-20 cm. Additionally, avoid overly dark background lighting. A plain-colored background, such as white, yields the best results.**

The IDs corresponding to the twelve types of cards are shown in the following table:
...
<td style="text-align: center;"><strong>Corresponding ID</strong></td>
<td style="text-align: center;"><strong>Image</strong></td>
<td style="text-align: center;"><strong>Corresponding ID</strong></td>
</tr>
<tr>
<td style="text-align: center;">White Background</td>
<td style="text-align: center;">1</td>
<td style="text-align: center;"><img src="../_static/media/chapter_6\section_17/image3.png" class="common_img" style="width:150px" /></td>
<td style="text-align: center;">2</td>
</tr>
<tr>
<td style="text-align: center;"><img src="../_static/media/chapter_6\section_17/image4.png" class="common_img" style="width:150px" /></td>
<td style="text-align: center;">3</td>
<td style="text-align: center;"><img src="../_static/media/chapter_6\section_17/image5.png" class="common_img" style="width:150px" /></td>
<td style="text-align: center;">4</td>
</tr>
<tr>
<td style="text-align: center;"><img src="../_static/media/chapter_6\section_17/image6.png" class="common_img" style="width:150px" /></td>
<td style="text-align: center;">5</td>
<td style="text-align: center;"><img src="../_static/media/chapter_6\section_17/image7.png" class="common_img" style="width:150px" /></td>
<td style="text-align: center;">6</td>
</tr>
<tr>
<td style="text-align: center;"><img src="../_static/media/chapter_6\section_17/image8.png" class="common_img" style="width:150px" /></td>
<td style="text-align: center;">7</td>
<td style="text-align: center;"><img src="../_static/media/chapter_6\section_17/image9.png" class="common_img" style="width:150px" /></td>
<td style="text-align: center;">8</td>
</tr>
<tr>
<td style="text-align: center;"><img src="../_static/media/chapter_6\section_17/image10.png" class="common_img" style="width:150px" /></td>
<td style="text-align: center;">9</td>
<td style="text-align: center;"><img src="../_static/media/chapter_6\section_17/image11.png" class="common_img" style="width:150px" /></td>
<td style="text-align: center;">10</td>
</tr>
<tr>
<td style="text-align: center;"><img src="../_static/media/chapter_6\section_17/image12.png" class="common_img" style="width:150px" /></td>
<td style="text-align: center;">11</td>
<td style="text-align: center;"><img src="../_static/media/chapter_6\section_17/image13.png" class="common_img" style="width:150px" /></td>
<td style="text-align: center;">12</td>
</tr>
<tr>
<td style="text-align: center;"><img src="../_static/media/chapter_6\section_17/image14.png" class="common_img" style="width:150px" /></td>
...
## **6.18 Garbage Classification**

### 6.18.1 Implementation Flowchart

<img src="../_static/media/chapter_6\section_18/image2.png" class="common_img" style="width:750px"  />

### 6.18.2 WonderCam Vision Module

<img src="../_static/media/chapter_6\section_18/image3.png" class="common_img" style="width:300px"  />

WonderCam is an easy-to-use AI vision sensor with built-in functions including color recognition, facial recognition, tag recognition, vision line following, number recognition, road sign recognition, image classification, and feature learning. It supports various controllers such as ESP32, micro:bit, Arduino, and Raspberry Pi, enabling easy implementation of a wide range of AI vision projects.

### 6.18.3 Program Download 

1. Connect the AiNova robot to the computer via USB cable.

2. In the WonderCode main interface, click **Connect device** and select the corresponding port. The port number is not fixed, please select according to the actual situation. In the example below, the port is COM3.

> [!NOTE]
>
> **If COM1 appears, do not select it, as it is typically a system communication interface.**

<img src="../_static/media/chapter_6\section_18/image4.png" class="common_img" style="width:400px" />

<img src="../_static/media/chapter_6\section_18/image5.png" style="width:1.71875in;height:0.44792in" />

3. After a successful connection, click the **Upload** button in upload mode on the right side.

   <img src="../_static/media/chapter_6\section_18/image6.png" class="common_img" style="width:400px" />

4. Finally, wait for the download to complete.

   <img src="../_static/media/chapter_6\section_18/image7.png" class="common_img" style="width:300px"  />

### 6.18.4 Implementation Results

Take out the five included number cards one by one and point them at the WonderCam Vision Module. The AiNova robot will then execute the corresponding output effects as shown in the table below:

|  ID  |                 Garbage Classification Card                  |                            Result                            |
| :--: | :----------------------------------------------------------: | :----------------------------------------------------------: |
|  1   |                       Blank background                       |                    RGB LED lights up red                     |
|  2   | <img src="../_static/media/chapter_6\section_18/image8.png" class="common_img" style="width:150px" /> |                   RGB LED lights up purple                   |
|  3   | <img src="../_static/media/chapter_6\section_18/image9.png" class="common_img" style="width:150px" /> |   RGB LED lights up green and plays **Two Tigers** melody    |
|  4   | <img src="../_static/media/chapter_6\section_18/image10.png" class="common_img" style="width:150px" /> | RGB LED lights up blue and plays **Twinkle Twinkle Little Star** melody |
|  5   | <img src="../_static/media/chapter_6\section_18/image11.png" class="common_img" style="width:150px" /> | RGB LED lights up yellow and plays **Two Little Donkeys** melody |

### 6.18.5 Program Brief Analysis

1. When AiNova starts, the vision module interface is initialized to port 9, the ultrasonic module indicator light is turned off, and the vision module is switched to road sign recognition mode. After these initialization steps are completed, an audible prompt is emitted by the buzzer.

   The `LEN_ON` variable is used to control the vision module fill light. A value of −1 turns the fill light off, while a value of 1 turns it on. Finally, the CoreX LED is set to pink, and the buzzer volume is set to 5.

<img src="../_static/media/chapter_6\section_18/image12.png" class="common_img" style="width:600px" />

2.  When Button A is pressed, change the value of the `LEN_ON` variable. Each press toggles it between 1 and -1, thereby turning the fill light on or off based on the `LEN_ON` variable value.

<img src="../_static/media/chapter_6\section_18/image13.png" class="common_img" style="width:600px" />

3.  In the main program, continuously update and obtain recognition results. Set the number with the highest confidence recognized by the vision module as **My Variables**, then set different implementation effects based on the value of **My Variables**. If **My Variable** is 1, set all LED colors to red.

<img src="../_static/media/chapter_6\section_18/image14.png" class="common_img" style="width:600px"  />

4.  If number 2 is recognized, set the LED color to purple.

<img src="../_static/media/chapter_6\section_18/image15.png" class="common_img" style="width:700px"  />

5.  If number 3 is recognized, set the LED color to green and play the **Two Tigers** music.

<img src="../_static/media/chapter_6\section_18/image16.png" class="common_img" style="width:700px"  />

- Part of the **Two Tigers** music editing code:

  <img src="../_static/media/chapter_6\section_18/image17.png" class="common_img" style="width:500px"  />

  6）If number 4 is recognized, set all LEDs to blue and play **Twinkle Twinkle Little Star**.

<img src="../_static/media/chapter_6\section_18/image18.png" class="common_img" style="width:600px"  />

- Part of the **Twinkle Twinkle Little Star** music code:

  <img src="../_static/media/chapter_6\section_18/image19.png" class="common_img" style="width:500px"  />

7）If number 5 is recognized, set the LEDs to light blue and play the **Little Donkey** melody.

<img src="../_static/media/chapter_6\section_18/image20.png" class="common_img" style="width:600px"  />

- Part of the **Little Donkey** music code:

  <img src="../_static/media/chapter_6\section_18/image21.png" class="common_img" style="width:500px"  />

8.  Otherwise, if other numbers are recognized, the LED lights up yellow. If no number is recognized, all LEDs are turned off.

<img src="../_static/media/chapter_6\section_18/image22.png" class="common_img" style="width:500px"/>
