...
(5) Finally, click the Restart button <img src="../_static/media/chapter_7/section_2/01/image10.png" style="width:70px" /> to reboot the robot car. The program will start running automatically.
...
(5) Finally, click the Restart button <img src="../_static/media/chapter_7/section_2/02/image10.png" style="width:70px" /> to reboot the robot car. The program will start running automatically.
...
(5) Finally, click the Restart button <img src="../_static/media/chapter_7/section_2/03/image10.png" style="width:70px" /> to reboot the robot car. The program will start running automatically.
...
(5) Finally, click the Restart button <img src="../_static/media/chapter_7/section_2/06/image10.png" style="width:70px" /> to reboot the robot car. The program will start running automatically.
...
(2) An object for motor control is created, along with the initialization of the I2C ultrasonic module object i2csonar_5 and the line follower sensor object lineSensor_4. An encoder motor object en_motor is also created. Next, the encoder motor is initialized, with its model specified as a TT motor. Finally, the RGB light on the ultrasonic module is turned off.

{lineno-start=5}

```
# initialize variables
i2csonar_5 = Hiwonder.I2CSonar(Hiwonder.Port(4))  
# Initialize the IIC interface of the glowing ultrasonic sensor (初始化发光超声波的IIC接口)
en_motor = Hiwonder.EncoderMotor
lineSensor_4 = Hiwonder.LineFollower4(Hiwonder.Port(4))  
# Initialize the IIC interface of the 4-channel line follower sensor (初始化四路巡线传感器的IIC接口)
...
i2csonar_5.setRGB(0,0x00,0x00,0x00)  # Turn off the RGB light of the glowing ultrasonic sensor (关闭发光超声波的RGB灯)
en_motor.setType(en_motor.TT_MOTOR)  # Initialize the encoder motor type as TT motor (初始化编码电机的型号为TT马达)
...
def start_main():
  ...
  while True:
    # Get data from the 4-channel line follower sensor (获取四路巡线传感器数据)
    _Sensor1 = (lineSensor_4.read(lineSensor_4.Sensor1))  
    ...
    if (((_Sensor1 and not _Sensor2)) and ((not _Sensor3 and _Sensor4))):  
    # If the line is detected in the middle (如果识别到线路在中间)
      en_motor.setSpeed(en_motor.AllMotor,40)  # Make the robot go straight (控制小车直行)
```
...
```
      ...
      if (((_Sensor1 and not _Sensor2)) and ((_Sensor3 and _Sensor4))):
        en_motor.setSpeed(en_motor.Motor1,6)  # Make the robot turn left (控制小车左转)
        en_motor.setSpeed(en_motor.Motor2,40)
      else:
        if (((_Sensor1 and _Sensor2)) and ((not _Sensor3 and _Sensor4))):
          en_motor.setSpeed(en_motor.Motor1,40)  # Make the robot turn right (控制小车右转)
...
(5) Finally, click the Restart button <img src="../_static/media/chapter_7/section_2/08/image10.png" style="width:70px" /> to reboot the robot car. The program will start running automatically.
...
(4) After connecting, click the Download button <img src="../_static/media/chapter_7/section_3/03/image8.png" style="width:70px" /> in the menu to upload the program to the AiNova controller. Wait for the message box at the bottom of the editor to confirm the download is complete.
...
(5) Finally, click the Restart button <img src="../_static/media/chapter_7/section_3/04/image10.png" style="width:70px" /> to reboot the robot car. The program will start running automatically.
...
(3) Click the Connect button <img src="../_static/media/chapter_7/section_3/06/image6.png" style="width:70px" /> in the top menu. When successfully connected, the icon will turn green <img src="../_static/media/chapter_7/section_3/06/image7.png" style="width:70px" />.
...
(5) Finally, click the Restart button <img src="../_static/media/chapter_7/section_3/07/image10.png" style="width:70px" /> to reboot the robot car. The program will start running automatically.
...
(3) Click the Connect button <img src="../_static/media/chapter_7/section_3/09/image6.png" style="width:70px" /> in the top menu. When successfully connected, the icon will turn green <img src="../_static/media/chapter_7/section_3/09/image7.png" style="width:70px" />.
...
(5) Finally, click the Restart button <img src="../_static/media/chapter_7/section_3/10/image10.png" style="width:70px" /> to reboot the robot car. The program will start running automatically.
...
(1) Open the Hiwonder Python editor software <img src="../_static/media/chapter_7/section_3/12/image4.png" style="width:70px" />.
...
(3) Click the Connect button <img src="../_static/media/chapter_7/section_3/12/image6.png" style="width:70px" /> in the top menu. When successfully connected, the icon will turn green <img src="../_static/media/chapter_7/section_3/12/image7.png" style="width:70px" />.

(4) After connecting, click the Download button <img src="../_static/media/chapter_7/section_3/12/image8.png" style="width:70px" /> in the menu to upload the program to the AiNova controller. Wait for the message box at the bottom of the editor to confirm the download is complete.

<img class="common_img" src="../_static/media/chapter_7/section_3/12/image9.png" />

(5) Finally, click the Restart button <img src="../_static/media/chapter_7/section_3/12/image10.png" style="width:70px" /> to reboot the robot car. The program will start running automatically.
...
(1) Open the Hiwonder Python editor software <img src="../_static/media/chapter_7/section_3/14/image4.png" style="width:70px" />.
...
(3) Click the Connect button <img src="../_static/media/chapter_7/section_3/14/image6.png" style="width:70px" /> in the top menu. When successfully connected, the icon will turn green <img src="../_static/media/chapter_7/section_3/14/image7.png" style="width:70px" />.

(4) After connecting, click the Download button <img src="../_static/media/chapter_7/section_3/14/image8.png" style="width:70px" /> in the menu to upload the program to the AiNova controller. Wait for the message box at the bottom of the editor to confirm the download is complete.

<img class="common_img" src="../_static/media/chapter_7/section_3/14/image9.png" />

(5) Finally, click the Restart button <img src="../_static/media/chapter_7/section_3/14/image10.png" style="width:70px" /> to reboot the robot car. The program will start running automatically.
...
(1) Open the Hiwonder Python editor software <img src="../_static/media/chapter_7/section_3/16/image4.png" style="width:70px" />.
...
(3) Click the Connect button <img src="../_static/media/chapter_7/section_3/16/image6.png" style="width:70px" /> in the top menu. When successfully connected, the icon will turn green <img src="../_static/media/chapter_7/section_3/16/image7.png" style="width:70px" />.

(4) After connecting, click the Download button <img src="../_static/media/chapter_7/section_3/16/image8.png" style="width:70px" /> in the menu to upload the program to the AiNova controller. Wait for the message box at the bottom of the editor to confirm the download is complete.

<img class="common_img" src="../_static/media/chapter_7/section_3/16/image9.png" />

(5) Finally, click the Restart button <img src="../_static/media/chapter_7/section_3/16/image10.png" style="width:70px" /> to reboot the robot car. The program will start running automatically.
