...
(1) Import the [AiNova Bluetooth Control.sb3](https://drive.google.com/drive/folders/12jUYlKAWNZz0T4Q1mNz6r6jR32CrrVe6?usp=sharing) program , or simply drag it onto the main interface of the programming software.
